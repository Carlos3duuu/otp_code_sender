...
# NOTE: Utilizando um dominio DEMO da mailtrap para envio de emails de confirmação
# a configuração de um domínio próprio deve ser realizado posteriormente para enviar emails para qualquer usuário

EMAIL_HOST = 'live.smtp.mailtrap.io'
EMAIL_HOST_USER = 'api'
EMAIL_HOST_PASSWORD = 'dcf4984939d95ae35cd87dee721f49d4'
EMAIL_PORT = '587'
EMAIL_USE_TLS = True